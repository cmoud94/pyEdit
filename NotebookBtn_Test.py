...
i1 = PhotoImage('img_close', file='icons/CloseBtn_Normal.png')
i2 = PhotoImage('img_close_mouse_over', file='icons/CloseBtn_MouseOver.png')
i3 = PhotoImage('img_close_pressed', file='icons/CloseBtn_Pressed.png')
